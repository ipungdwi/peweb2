...
$routes->get('/province/insert', 'Province::insert');
$routes->post('/province/insert', 'Province::insert_save');
$routes->get('/province/(:segment)', 'Province::update/$1');
$routes->post('/province/(:segment)', 'Province::update_save/$1');
$routes->get('/province/delete/(:segment)', 'Province::delete/$1');
...
//validation & upload
$routes->get('/kota2', 'Kota2::list');
$routes->get('/kota2/insert', 'Kota2::insert');
$routes->post('/kota2/insert', 'Kota2::insert_save');
$routes->get('/kota2/upload/(:segment)', 'Kota2::upload/$1');
$routes->post('/kota2/upload/(:segment)', 'Kota2::upload_save/$1');
//end crud 1-Many table
//export
